        ...
        <div>
          <h2 className="text-center text-white bg-success m-2">Личный кабинет</h2>
            <form id="sab" className="w-50 m-auto p-3" style={{ 'minWidth': '300px' }}onSubmit={load}>
                ...
                <button type="submit" className="btn bg-success text-white">Подписаться</button>
            </form>
            <div className="alert  d-none w-50 m-auto p-3 bg-success text-white" role="alert" rev={message} id="message">
